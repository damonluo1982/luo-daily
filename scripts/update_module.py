...
MODULE_CONFIG = {
    "stock": {
        ...
        "queries": [
            ...
            "A股 本周 关键事件 财经新闻 政策",
            "COMEX黄金期货 本周每日收盘价 gold futures daily close this week",
        ],
        "prompt": """请更新「A股投资预测」模块，排列顺序严格为：
①昨日收盘速览（指数卡片：上证/深成/创业板/沪深300/科创50的收盘点位+涨跌幅，两市成交额、北向资金、涨跌比，后接1段盘面要点）
②本周总结（①-④条要点，含风格切换/资金流向分析）
③下周操作建议（对明天、未来一周、未来一个月的建议，用行业ETF视角，不对用户持仓给意见）
④本周涨跌幅最大板块（TOP5上涨+TOP5下跌，含周涨幅）
⑤本周关键事件（3-5条）
⑥黄金·过去一周每日收盘（COMEX期货，flex横向排列每日数据：日期+收盘价+涨跌幅，底部1行周涨幅摘要）
